...
- [The code for the Strangemood Program on Github](https://github.com/strangemoodfoundation/strangemood)
...
No, it's a marketplace to buy and sell games. You can put a pay to earn game on the Strangemood protocol, probably no one will stop you. But it's not explicitly for any type of game.
