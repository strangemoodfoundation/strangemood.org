...
tagline: "Crypto is dumb, but this isn't"
faq: ["solana"]
---
...
Criticism of these views are warranted, and have [been widely](https://web3isgoinggreat.com/) [discussed](https://www.mollywhite.net/annotations/latecomers-guide-to-crypto#). I would ask that, as you learn about Strangemood, you build your view from first principles, and not from comparisons to what other's have done.
...
Strangemood's goal is to create a marketplace for video games that's owned, as an asset, by the sellers. The point is not to restrict the supply of the asset and speculate on its future value. It's that, if done correctly, owning the marketplace is cheaper than renting it from a monpoloy that can charge you unreasonable prices. It's no different than a housing market. It is cheaper to buy a house when there is an abundant supply of housing than it is to rent when there are only a few landlords.
