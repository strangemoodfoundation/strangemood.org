     ...
     <div className="relative bg-white py-8 sm:py-12 lg:py-16">
       <div className="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:max-w-6xl lg:px-8">
         ...
         <p className="mx-auto mt-2 max-w-prose text-xl text-gray-500">
           Strangemood is a protocol, not a company. We think that's pretty cool 
           because if what it enables.
         </p> */}
         <h2 className="mt-12 text-base font-semibold uppercase tracking-wider text-indigo-600">Benefits</h2>
         <div className="mt-6">
