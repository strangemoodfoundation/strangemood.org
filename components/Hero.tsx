   ...
   return (
      <>
         <div className="relative">
            <div className="mt-0 max-w-6xl mx-auto sm:px-6 lg:px-8">
               <div className={`relative shadow-xl shadow-${color}-200 sm:rounded-2xl sm:overflow-hidden`}>
                  <div className="absolute inset-0">
                     ...
                     />
                     <div className={`absolute inset-0 bg-gradient-to-r from-purple-800 to-${color}-700 mix-blend-multiply`} />
                  </div>
                  <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                     <h1 className="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                        <span className="block text-white">It's like Steam,</span>
                        <span className={`block text-${color}-200`}>but as a co-op</span>
                     </h1>
                     <p className={`mt-6 max-w-lg mx-auto text-center text-xl text-${color}-200 sm:max-w-3xl`}>
